...
/**
 * isSequential 指定多实例是按照并行或者串行的方式进行， 如果使用串行方式nrOfActiveInstances 变量始终是1 。
 * isSequential串行并行是针对于assigneeList中的用户集合来说的， 如果是并行assigneeList集合中的每个用户按照顺序执行。
 * 任务会签处理 一个任务需要多热进行处理
 * 
 * 
 * @author wsylp
...
public class CounterSignTest {
	...
	public void getTaskByDeploymentId() {
		// 任务处理人【0001】,任务id【42504】,任务名称【总经理审批】,任务流程定义id【counterSign:1:32504】,
		// 流程定义key【zjlsp】,任务拥有者【null】
	...
	public void finshTask() {
		...
		// 57537
		// 57544
		String taskId = "12530";// 35030 //35037 //35044
