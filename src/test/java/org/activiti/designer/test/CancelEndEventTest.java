...
public class CancelEndEventTest {
	...
	public void deplomentActiviti() {
		...
		map.put("name", "消息CancelEndEvent");// 名称
		map.put("id", "CancelEndEvent");// id
		map.put("category", "CancelEndEvent流程");// 类别
	...
	public void startActiviti() {
		...
		runtimeService.startProcessInstanceByKey("CancelEndEvent", variables);
