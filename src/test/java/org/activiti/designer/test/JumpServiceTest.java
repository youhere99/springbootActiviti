...
import boot.spring.po.JDJumpTaskCmd;
...
public class JumpServiceTest {
	...
	public void deplomentActiviti() {
		...
		map.put("tenantId", "http://www.shareniu.com/article/35.htm");// 类别
	...
	public void jumpTask1() {
		...
		ReadOnlyProcessDefinition processDefinitionEntity = (ReadOnlyProcessDefinition) repositoryService
				.getProcessDefinition("jumpTask:1:30004");
		// 目标节点
	...
	public void jumpTask2() {
		...
		String executionId = "32501";
		ActivityImpl destinationActivity = (ActivityImpl) processDefinitionEntity.findActivity("usertask3");
