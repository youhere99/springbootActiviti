...
public class SpringBootWithActivitiApplicationTests {
	...
	private static final Logger log = LoggerFactory.getLogger(SpringBootWithActivitiApplicationTests.class);
	...
	public void deployProcessDefinition() {
		...
		Deployment deployment = repositoryService.createDeployment()// 创建部署对象
				.name("blankStart演示3")// 声明流程的名称
				.addClasspathResource("diagrams/blankStart.bpmn").addClasspathResource("diagrams/blankStart.png")
				.deploy();// 完成部署
	...
	public void startProcessInstance() {
		...
		String processDefinitionKey = "blankStart";// 流程定义的key,也就是bpmn中存在的ID
